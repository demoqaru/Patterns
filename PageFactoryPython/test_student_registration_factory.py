...
from student_registration_page_factory import StudentRegistrationPage
import time
def test_successful_registration():
    ...
    try:
        (page.open()
            ...
            .select_hobby_sports()
            .select_hobby_music()
            .upload_picture(r"C:UsersUserDownloads	est.jpg")
        ...
        # Пауза 10 секунд, чтобы посмотреть результат
        time.sleep(10)
    finally:
        driver.quit()
